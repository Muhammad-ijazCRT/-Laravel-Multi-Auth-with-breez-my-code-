...
@section('admin')
    ...
    <div class="wrapper">
        ...
        <div class="content_wrapper">
            ...
            {{-- auth user name and email --}}

            <div class="mt-3">
                <h2> user name: {{ Auth::guard('admin')->user()->name }} </h2>
                <h2> user name: {{ Auth::guard('admin')->user()->email }} </h2>
            </div>
                ...
                <section class="table_area">
                    <div class="">
                        <div class="panel_header">
                            <div class="panel_title"><span>FooTable with row toggler, sorting,
                                    filter and pagination</span></div>
                        </div>
